...
Write your proposal following **Task 2: The Proposal template**: Add correct template below.
...
<div class = "tasklist">
  ...
  Add appropriate course information for task 2 here.
   ...
   Delete this line if there is no task 3. 
...
(task2:A)=
## Section A: Overview
Remove content or add as needed according to the course requirements for task 2.
:::{sidebar} Watch 
